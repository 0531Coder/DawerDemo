...
import com.demo.moutain.dawerdemo.interfaze.OnRecyclerViewOnClickListener;
...
public class DoubanMomentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<FirListEntity.PostsBean> list;
    ...
    public DoubanMomentAdapter(@NonNull Context context, @NonNull List<FirListEntity.PostsBean> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if ( !(holder instanceof FooterViewHolder)) {
            FirListEntity.PostsBean item = list.get(position);
